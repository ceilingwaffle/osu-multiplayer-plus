// interface Event<EventName, EventDataType> {
//   type: EventName;
...
// class DispatcherVersion1<E extends EventType> {
...
// type EventType = LeaderboardReadyEvent | FetchedNewOsuApiMultiplayerResults;
...
//   return true;
// }
// const d = new DispatcherVersion1<EventType>();
